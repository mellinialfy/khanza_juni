 ...
 * @author dosen
 */
public class MasterAbdomen extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterAbdomen(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={"Abdomen", "id"};
        tabMode=new DefaultTableModel(null,row){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        tbAbdomen.setModel(tabMode);

        tbAbdomen.setPreferredScrollableViewportSize(new Dimension(800,800));
        tbAbdomen.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 2; i++) {
            TableColumn column = tbAbdomen.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbAbdomen.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Abdomen ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        tbAbdomen.setAutoCreateRowSorter(true);
        tbAbdomen.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbAbdomen.setComponentPopupMenu(Popup);
        tbAbdomen.setName("tbAbdomen"); // NOI18N
        tbAbdomen.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbAbdomenMouseClicked(evt);
            }
        });
        tbAbdomen.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbAbdomenKeyReleased(evt);
            }
        });
        Scroll.setViewportView(tbAbdomen);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNm.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.simpan("tb_abdomen(abdomen, created_at)","'"+TNm.getText()+"'","'"+formattedDateTime+"'","id");
...
//            Valid.pindah(evt,TAlumni,BtnBatal);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        try {
            ...
            Sequel.hapus("tb_abdomen",
                        "status='0',updated_at='"+formattedDateTime+
                        "'","id='"+tbAbdomen.getValueAt(tbAbdomen.getSelectedRow(),1).toString()+"'");
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        ...
        if(TNm.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.edit("tb_abdomen",
                        "abdomen='"+TNm.getText()+"',updated_at='"+formattedDateTime+
                        "'","id='"+tbAbdomen.getValueAt(tbAbdomen.getSelectedRow(),1).toString()+"'");
...
//            Valid.pindah(evt, BtnHapus);
    ...
    private void tbAbdomenMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbAbdomenMouseClicked
...
}//GEN-LAST:event_tbAbdomenMouseClicked
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void tbAbdomenKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbAbdomenKeyReleased
        if(tabMode.getRowCount()!=0){
    ...
    }//GEN-LAST:event_tbAbdomenKeyReleased
    ...
    */
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            MasterAbdomen dialog = new MasterAbdomen(new javax.swing.JFrame(), true);
...
//        
    ...
    private widget.Table tbAbdomen;
    ...
    private void getData() {
        int row=tbAbdomen.getSelectedRow();
        if(row!= -1){
            
            TNm.setText(tbAbdomen.getValueAt(row,0).toString());
        }
    }
