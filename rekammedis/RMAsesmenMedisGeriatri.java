 ...
 * @author perpustakaan
 */
public final class RMAsesmenMedisGeriatri extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMAsesmenMedisGeriatri(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-09-2023" }));
        ...
        scrollPane2.setBounds(70, 100, 715, 53);

        scrollPane3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane3.setName("scrollPane3"); // NOI18N

        Uraian1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Uraian1.setColumns(20);
        Uraian1.setRows(5);
        Uraian1.setName("Uraian1"); // NOI18N
        Uraian1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Uraian1KeyPressed(evt);
            }
        });
        scrollPane3.setViewportView(Uraian1);

        FormInput.add(scrollPane3);
        scrollPane3.setBounds(74, 70, 715, 53);
    ...
    private void Uraian1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Uraian1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Uraian1KeyPressed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMAsesmenMedisGeriatri dialog = new RMAsesmenMedisGeriatri(new javax.swing.JFrame(), true);
    ...
    private widget.TextArea Uraian1;
