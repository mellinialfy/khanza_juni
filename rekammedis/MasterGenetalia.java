 ...
 * @author dosen
 */
public class MasterGenetalia extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterGenetalia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={"Genetalia", "id"};
        tabMode=new DefaultTableModel(null,row){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        tbGenetalia.setModel(tabMode);

        tbGenetalia.setPreferredScrollableViewportSize(new Dimension(800,800));
        tbGenetalia.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 2; i++) {
            TableColumn column = tbGenetalia.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbGenetalia.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Genetalia ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        tbGenetalia.setAutoCreateRowSorter(true);
        tbGenetalia.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbGenetalia.setComponentPopupMenu(Popup);
        tbGenetalia.setName("tbGenetalia"); // NOI18N
        tbGenetalia.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbGenetaliaMouseClicked(evt);
            }
        });
        tbGenetalia.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbGenetaliaKeyReleased(evt);
            }
        });
        Scroll.setViewportView(tbGenetalia);
...
//        Valid.pindah(evt,TKd,CmbJk);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNm.getText().trim().equals("")){
            Valid.textKosong(TNm,"Genetalia");
        }else{
            try { 
                ...
                Sequel.simpan("tb_genetalia(genetalia, created_at)","'"+TNm.getText()+"'","'"+formattedDateTime+"'","id");
...
//            Valid.pindah(evt,TAlumni,BtnBatal);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        try {
            ...
            Sequel.hapus("tb_genetalia",
                        "status='0',updated_at='"+formattedDateTime+
                        "'","id='"+tbGenetalia.getValueAt(tbGenetalia.getSelectedRow(),1).toString()+"'");
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        ...
        if(TNm.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.edit("tb_genetalia",
                        "genetalia='"+TNm.getText()+"',updated_at='"+formattedDateTime+
                        "'","id='"+tbGenetalia.getValueAt(tbGenetalia.getSelectedRow(),1).toString()+"'");
...
//            Valid.pindah(evt, BtnHapus);
    ...
    private void tbGenetaliaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbGenetaliaMouseClicked
...
}//GEN-LAST:event_tbGenetaliaMouseClicked
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void tbGenetaliaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbGenetaliaKeyReleased
        if(tabMode.getRowCount()!=0){
    ...
    }//GEN-LAST:event_tbGenetaliaKeyReleased
    ...
    */
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            MasterGenetalia dialog = new MasterGenetalia(new javax.swing.JFrame(), true);
...
//        
    ...
    private widget.Table tbGenetalia;
    ...
    private void tampil() {
        ...
        try {
            stat=koneksi.prepareStatement(
                   "select genetalia, id from tb_genetalia where status=1");
            try{
    ...
    private void getData() {
        int row=tbGenetalia.getSelectedRow();
        if(row!= -1){
            
            TNm.setText(tbGenetalia.getValueAt(row,0).toString());
        }
    }
