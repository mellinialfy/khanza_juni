 ...
 * @author dosen
 */
public class MasterUub extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterUub(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tbUub.setModel(tabMode);

        tbUub.setPreferredScrollableViewportSize(new Dimension(800,800));
        tbUub.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 2; i++) {
            TableColumn column = tbUub.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbUub.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ UUB ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        tbUub.setAutoCreateRowSorter(true);
        tbUub.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbUub.setComponentPopupMenu(Popup);
        tbUub.setName("tbUub"); // NOI18N
        tbUub.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbUubMouseClicked(evt);
            }
        });
        tbUub.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbUubKeyReleased(evt);
            }
        });
        Scroll.setViewportView(tbUub);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNm.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.simpan("tb_uub(uub, created_at)","'"+TNm.getText()+"'","'"+formattedDateTime+"'","id");
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        try {
            ...
            Sequel.hapus("tb_uub",
                        ...
                        "'","id='"+tbUub.getValueAt(tbUub.getSelectedRow(),1).toString()+"'");
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        ...
        if(TNm.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.edit("tb_uub",
                        "uub='"+TNm.getText()+"',updated_at='"+formattedDateTime+
                        "'","id='"+tbUub.getValueAt(tbUub.getSelectedRow(),1).toString()+"'");
...
//            Valid.pindah(evt, BtnHapus);
    ...
    private void tbUubMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbUubMouseClicked
...
}//GEN-LAST:event_tbUubMouseClicked
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void tbUubKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbUubKeyReleased
        if(tabMode.getRowCount()!=0){
    ...
    }//GEN-LAST:event_tbUubKeyReleased
    ...
    */
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            MasterUub dialog = new MasterUub(new javax.swing.JFrame(), true);
...
//        
    ...
    private void getData() {
        int row=tbUub.getSelectedRow();
        if(row!= -1){
            
            TNm.setText(tbUub.getValueAt(row,0).toString());
        }
    }
