 ...
 * @author dosen
 */
public class MasterEkstremnitas extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterEkstremnitas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={"Ekstremnitas", "id"};
        tabMode=new DefaultTableModel(null,row){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        tbEkstremnitas.setModel(tabMode);

        tbEkstremnitas.setPreferredScrollableViewportSize(new Dimension(800,800));
        tbEkstremnitas.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 2; i++) {
            TableColumn column = tbEkstremnitas.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbEkstremnitas.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        tbEkstremnitas = new widget.Table();
        ...
        tbEkstremnitas.setAutoCreateRowSorter(true);
        tbEkstremnitas.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbEkstremnitas.setComponentPopupMenu(Popup);
        tbEkstremnitas.setName("tbEkstremnitas"); // NOI18N
        tbEkstremnitas.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbEkstremnitasMouseClicked(evt);
            }
        });
        tbEkstremnitas.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbEkstremnitasKeyReleased(evt);
            }
        });
        Scroll.setViewportView(tbEkstremnitas);
...
//        Valid.pindah(evt,TKd,CmbJk);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNm.getText().trim().equals("")){
            Valid.textKosong(TNm,"Ekstremnitas");
        }else{
            try { 
                ...
                Sequel.simpan("tb_ekstremnitas(ekstremnitas, created_at)","'"+TNm.getText()+"'","'"+formattedDateTime+"'","id");
...
//            Valid.pindah(evt,TAlumni,BtnBatal);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        try {
            ...
            Sequel.hapus("tb_ekstremnitas",
                        "status='0',updated_at='"+formattedDateTime+
                        "'","id='"+tbEkstremnitas.getValueAt(tbEkstremnitas.getSelectedRow(),1).toString()+"'");
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        ...
        if(TNm.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.edit("tb_ekstremnitas",
                        "ekstremnitas='"+TNm.getText()+"',updated_at='"+formattedDateTime+
                        "'","id='"+tbEkstremnitas.getValueAt(tbEkstremnitas.getSelectedRow(),1).toString()+"'");
...
//            Valid.pindah(evt, BtnHapus);
    ...
    private void tbEkstremnitasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbEkstremnitasMouseClicked
...
}//GEN-LAST:event_tbEkstremnitasMouseClicked
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void tbEkstremnitasKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbEkstremnitasKeyReleased
        if(tabMode.getRowCount()!=0){
    ...
    }//GEN-LAST:event_tbEkstremnitasKeyReleased
    ...
    */
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            MasterEkstremnitas dialog = new MasterEkstremnitas(new javax.swing.JFrame(), true);
...
//        
    ...
    private widget.Table tbEkstremnitas;
    ...
    private void getData() {
        int row=tbEkstremnitas.getSelectedRow();
        if(row!= -1){
            
            TNm.setText(tbEkstremnitas.getValueAt(row,0).toString());
        }
    }
