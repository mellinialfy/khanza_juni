 ...
 * @author dosen
 */
public class MasterKepala extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterKepala(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={"Kepala", "id"};
        tabMode=new DefaultTableModel(null,row){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        tbKepala.setModel(tabMode);

        tbKepala.setPreferredScrollableViewportSize(new Dimension(800,800));
        tbKepala.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 2; i++) {
            TableColumn column = tbKepala.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbKepala.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Kepala ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        tbKepala.setAutoCreateRowSorter(true);
        tbKepala.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbKepala.setComponentPopupMenu(Popup);
        tbKepala.setName("tbKepala"); // NOI18N
        tbKepala.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbKepalaMouseClicked(evt);
            }
        });
        tbKepala.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbKepalaKeyReleased(evt);
            }
        });
        Scroll.setViewportView(tbKepala);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNm.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.simpan("tb_kepala(kepala, created_at)","'"+TNm.getText()+"'","'"+formattedDateTime+"'","id");
...
//            Valid.pindah(evt,TAlumni,BtnBatal);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        try {
            ...
            Sequel.hapus("tb_kepala",
                        "status='0',updated_at='"+formattedDateTime+
                        "'","id='"+tbKepala.getValueAt(tbKepala.getSelectedRow(),1).toString()+"'");
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        ...
        if(TNm.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.edit("tb_kepala",
                        "kepala='"+TNm.getText()+"',updated_at='"+formattedDateTime+
                        "'","id='"+tbKepala.getValueAt(tbKepala.getSelectedRow(),1).toString()+"'");
...
//            Valid.pindah(evt, BtnHapus);
    ...
    private void tbKepalaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbKepalaMouseClicked
...
}//GEN-LAST:event_tbKepalaMouseClicked
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void tbKepalaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbKepalaKeyReleased
        if(tabMode.getRowCount()!=0){
    ...
    }//GEN-LAST:event_tbKepalaKeyReleased
    ...
    */
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            MasterKepala dialog = new MasterKepala(new javax.swing.JFrame(), true);
...
//        
    ...
    private void getData() {
        int row=tbKepala.getSelectedRow();
        if(row!= -1){
            
            TNm.setText(tbKepala.getValueAt(row,0).toString());
        }
    }
