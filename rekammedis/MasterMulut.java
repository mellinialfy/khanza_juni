 ...
 * @author dosen
 */
public class MasterMulut extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterMulut(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tbMulut.setModel(tabMode);

        tbMulut.setPreferredScrollableViewportSize(new Dimension(800,800));
        tbMulut.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 2; i++) {
            TableColumn column = tbMulut.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbMulut.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Mulut ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        tbMulut.setAutoCreateRowSorter(true);
        tbMulut.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbMulut.setComponentPopupMenu(Popup);
        tbMulut.setName("tbMulut"); // NOI18N
        tbMulut.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbMulutMouseClicked(evt);
            }
        });
        tbMulut.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbMulutKeyReleased(evt);
            }
        });
        Scroll.setViewportView(tbMulut);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNm.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.simpan("tb_mulut(mulut, created_at)","'"+TNm.getText()+"'","'"+formattedDateTime+"'","id");
...
//            Valid.pindah(evt,TAlumni,BtnBatal);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        try {
            ...
            Sequel.hapus("tb_mulut",
                        "status='0',updated_at='"+formattedDateTime+
                        "'","id='"+tbMulut.getValueAt(tbMulut.getSelectedRow(),1).toString()+"'");
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        ...
        if(TNm.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.edit("tb_mulut",
                        "mulut='"+TNm.getText()+"',updated_at='"+formattedDateTime+
                        "'","id='"+tbMulut.getValueAt(tbMulut.getSelectedRow(),1).toString()+"'");
...
//            Valid.pindah(evt, BtnHapus);
    ...
    private void tbMulutMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbMulutMouseClicked
...
}//GEN-LAST:event_tbMulutMouseClicked
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void tbMulutKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbMulutKeyReleased
        if(tabMode.getRowCount()!=0){
    ...
    }//GEN-LAST:event_tbMulutKeyReleased
    ...
    */
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            MasterMulut dialog = new MasterMulut(new javax.swing.JFrame(), true);
...
//        
    ...
    private void getData() {
        int row=tbMulut.getSelectedRow();
        if(row!= -1){
            
            TNm.setText(tbMulut.getValueAt(row,0).toString());
        }
    }
