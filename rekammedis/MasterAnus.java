 ...
 * @author dosen
 */
public class MasterAnus extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterAnus(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tbAnus.setModel(tabMode);

        tbAnus.setPreferredScrollableViewportSize(new Dimension(800,800));
        tbAnus.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 2; i++) {
            TableColumn column = tbAnus.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbAnus.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Anus ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        tbAnus.setAutoCreateRowSorter(true);
        tbAnus.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbAnus.setComponentPopupMenu(Popup);
        tbAnus.setName("tbAnus"); // NOI18N
        tbAnus.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbAnusMouseClicked(evt);
            }
        });
        tbAnus.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbAnusKeyReleased(evt);
            }
        });
        Scroll.setViewportView(tbAnus);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNm.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.simpan("tb_anus(anus, created_at)","'"+TNm.getText()+"'","'"+formattedDateTime+"'","id");
...
//            Valid.pindah(evt,TAlumni,BtnBatal);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        try {
            ...
            Sequel.hapus("tb_anus",
                        "status='0',updated_at='"+formattedDateTime+
                        "'","id='"+tbAnus.getValueAt(tbAnus.getSelectedRow(),1).toString()+"'");
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        ...
        if(TNm.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.edit("tb_anus",
                        "anus='"+TNm.getText()+"',updated_at='"+formattedDateTime+
                        "'","id='"+tbAnus.getValueAt(tbAnus.getSelectedRow(),1).toString()+"'");
...
//            Valid.pindah(evt, BtnHapus);
    ...
    private void tbAnusMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbAnusMouseClicked
...
}//GEN-LAST:event_tbAnusMouseClicked
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void tbAnusKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbAnusKeyReleased
        if(tabMode.getRowCount()!=0){
    ...
    }//GEN-LAST:event_tbAnusKeyReleased
    ...
    */
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            MasterAnus dialog = new MasterAnus(new javax.swing.JFrame(), true);
...
//        
    ...
    private void tampil() {
        ...
        try {
            stat=koneksi.prepareStatement(
                   "select anus, id from tb_anus where status=1");
            try{
    ...
    private void getData() {
        int row=tbAnus.getSelectedRow();
        if(row!= -1){
            
            TNm.setText(tbAnus.getValueAt(row,0).toString());
        }
    }
