 ...
 * @author dosen
 */
public class MasterTht extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterTht(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tbTht.setModel(tabMode);

        tbTht.setPreferredScrollableViewportSize(new Dimension(800,800));
        tbTht.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 2; i++) {
            TableColumn column = tbTht.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbTht.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        tbTht.setAutoCreateRowSorter(true);
        tbTht.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbTht.setComponentPopupMenu(Popup);
        tbTht.setName("tbTht"); // NOI18N
        tbTht.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbThtMouseClicked(evt);
            }
        });
        tbTht.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbThtKeyReleased(evt);
            }
        });
        Scroll.setViewportView(tbTht);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNm.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.simpan("tb_tht(tht, created_at)","'"+TNm.getText()+"'","'"+formattedDateTime+"'","id");
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        try {
            ...
            Sequel.hapus("tb_tht",
                        ...
                        "'","id='"+tbTht.getValueAt(tbTht.getSelectedRow(),1).toString()+"'");
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        ...
        if(TNm.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.edit("tb_tht",
                        "tht='"+TNm.getText()+"',updated_at='"+formattedDateTime+
                        "'","id='"+tbTht.getValueAt(tbTht.getSelectedRow(),1).toString()+"'");
...
//            Valid.pindah(evt, BtnHapus);
    ...
    private void tbThtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbThtMouseClicked
...
}//GEN-LAST:event_tbThtMouseClicked
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void tbThtKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbThtKeyReleased
        if(tabMode.getRowCount()!=0){
    ...
    }//GEN-LAST:event_tbThtKeyReleased
    ...
    */
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            MasterTht dialog = new MasterTht(new javax.swing.JFrame(), true);
...
//        
    ...
    private void getData() {
        int row=tbTht.getSelectedRow();
        if(row!= -1){
            
            TNm.setText(tbTht.getValueAt(row,0).toString());
        }
    }
