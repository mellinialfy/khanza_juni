 ...
 * @author dosen
 */
public class MasterPunggung extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterPunggung(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={"Punggung", "id"};
        tabMode=new DefaultTableModel(null,row){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        tbPunggung.setModel(tabMode);

        tbPunggung.setPreferredScrollableViewportSize(new Dimension(800,800));
        tbPunggung.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 2; i++) {
            TableColumn column = tbPunggung.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbPunggung.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Punggung ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        tbPunggung.setAutoCreateRowSorter(true);
        tbPunggung.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbPunggung.setComponentPopupMenu(Popup);
        tbPunggung.setName("tbPunggung"); // NOI18N
        tbPunggung.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbPunggungMouseClicked(evt);
            }
        });
        tbPunggung.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbPunggungKeyReleased(evt);
            }
        });
        Scroll.setViewportView(tbPunggung);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNm.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.simpan("tb_punggung(punggung, created_at)","'"+TNm.getText()+"'","'"+formattedDateTime+"'","id");
...
//            Valid.pindah(evt,TAlumni,BtnBatal);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        try {
            ...
            Sequel.hapus("tb_punggung",
                        "status='0',updated_at='"+formattedDateTime+
                        "'","id='"+tbPunggung.getValueAt(tbPunggung.getSelectedRow(),1).toString()+"'");
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        ...
        if(TNm.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.edit("tb_punggung",
                        "punggung='"+TNm.getText()+"',updated_at='"+formattedDateTime+
                        "'","id='"+tbPunggung.getValueAt(tbPunggung.getSelectedRow(),1).toString()+"'");
...
//            Valid.pindah(evt, BtnHapus);
    ...
    private void tbPunggungMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbPunggungMouseClicked
...
}//GEN-LAST:event_tbPunggungMouseClicked
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void tbPunggungKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbPunggungKeyReleased
        if(tabMode.getRowCount()!=0){
    ...
    }//GEN-LAST:event_tbPunggungKeyReleased
    ...
    */
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            MasterPunggung dialog = new MasterPunggung(new javax.swing.JFrame(), true);
...
//        
    ...
    private widget.Table tbPunggung;
    ...
    private void getData() {
        int row=tbPunggung.getSelectedRow();
        if(row!= -1){
            
            TNm.setText(tbPunggung.getValueAt(row,0).toString());
        }
    }
