 ...
 * @author perpustakaan
 */
public final class RMPemeriksaanUrologi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPemeriksaanUrologi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        tbMasalahDetailMasalah.setDefaultRenderer(Object.class, new WarnaTable());
        ...
        buli.setDocument(new batasInput((int)150).getKata(buli));
...
//        ChkAccor.setSelected(false);
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pemeriksaan USG Urologi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        scrollPane1.setBounds(580, 90, 260, 53);

        jLabel30.setText("Ginjal Kanan :");
        ...
        scrollPane2.setBounds(179, 90, 260, 53);

        jLabel31.setText("Ginjal Kiri :");
        ...
        buli.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        buli.setColumns(30);
        buli.setRows(5);
        buli.setName("buli"); // NOI18N
        buli.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                buliKeyPressed(evt);
            }
        });
        scrollPane3.setViewportView(buli);

        FormInput.add(scrollPane3);
        scrollPane3.setBounds(179, 150, 260, 53);

        TglAsuhan.setForeground(new java.awt.Color(50, 70, 50));
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "21-07-2023 10:02:22" }));
        ...
        jLabel33.setText("Buli :");
        jLabel33.setToolTipText("");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(0, 150, 175, 23);
        ...
        jLabel98.setText("I. USG UROLOGI");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
        ...
        }else if(buli.getText().trim().equals("")){
            Valid.textKosong(buli,"Buli");
            ...
            if(Sequel.menyimpantf("penilaian_usg_urologi","?,?,?,?,?,?"
                    ...
                    TNoRw.getText(),
                        ...
                        GinjalKanan.getText(),
                GinjalKiri.getText(),buli.getText(),
                    KdPetugas.getText()
                })==true){
            ...
            if(tbObat.getSelectedRow()>-1){
                if(Sequel.mengedittf("penilaian_usg_urologi","no_rawat=?","no_rawat=?,tanggal=?,ginjal_kanan=?,ginjal_kiri=?,buli=?,"+
                    ...
                    TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),
                        GinjalKanan.getText(),GinjalKiri.getText(),buli.getText(),KdPetugas.getText(),TNoRw.getText()
                     })==true){
                        tampil();
                        emptTeks();
...
//            Valid.pindah(evt,TCari,BtnDokter);
    ...
    private void buliKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buliKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_buliKeyPressed
...
//        Informasi.requestFocus();
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            buli.setText(tbObat.getValueAt(tbObat.getSelectedRow(),8).toString());
