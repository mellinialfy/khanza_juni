 ...
 * @author dosen
 */
public class MasterTaliPusat extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterTaliPusat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={"Tali Pusat", "id"};
        tabMode=new DefaultTableModel(null,row){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        tbTaliPusat.setModel(tabMode);

        tbTaliPusat.setPreferredScrollableViewportSize(new Dimension(800,800));
        tbTaliPusat.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 2; i++) {
            TableColumn column = tbTaliPusat.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbTaliPusat.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Tali Pusat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        tbTaliPusat.setAutoCreateRowSorter(true);
        tbTaliPusat.setToolTipText("Silahkan klik untuk memilih data yang mau diedit ataupun dihapus");
        tbTaliPusat.setComponentPopupMenu(Popup);
        tbTaliPusat.setName("tbTaliPusat"); // NOI18N
        tbTaliPusat.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbTaliPusatMouseClicked(evt);
            }
        });
        tbTaliPusat.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbTaliPusatKeyReleased(evt);
            }
        });
        Scroll.setViewportView(tbTaliPusat);
...
//        Valid.pindah(evt,TKd,CmbJk);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNm.getText().trim().equals("")){
            Valid.textKosong(TNm,"Tali Pusat");
        }else{
            try { 
                ...
                Sequel.simpan("tb_tali_pusat(tali_pusat, created_at)","'"+TNm.getText()+"'","'"+formattedDateTime+"'","id");
...
//            Valid.pindah(evt,TAlumni,BtnBatal);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        try {
            ...
            Sequel.hapus("tb_tali_pusat",
                        "status='0',updated_at='"+formattedDateTime+
                        "'","id='"+tbTaliPusat.getValueAt(tbTaliPusat.getSelectedRow(),1).toString()+"'");
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        ...
        if(TNm.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.edit("tb_tali_pusat",
                        "tali_pusat='"+TNm.getText()+"',updated_at='"+formattedDateTime+
                        "'","id='"+tbTaliPusat.getValueAt(tbTaliPusat.getSelectedRow(),1).toString()+"'");
...
//            Valid.pindah(evt, BtnHapus);
    ...
    private void tbTaliPusatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbTaliPusatMouseClicked
...
}//GEN-LAST:event_tbTaliPusatMouseClicked
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void tbTaliPusatKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbTaliPusatKeyReleased
        if(tabMode.getRowCount()!=0){
    ...
    }//GEN-LAST:event_tbTaliPusatKeyReleased
    ...
    */
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            MasterTaliPusat dialog = new MasterTaliPusat(new javax.swing.JFrame(), true);
...
//        
    ...
    private widget.Table tbTaliPusat;
    ...
    private void getData() {
        int row=tbTaliPusat.getSelectedRow();
        if(row!= -1){
            
            TNm.setText(tbTaliPusat.getValueAt(row,0).toString());
        }
    }
