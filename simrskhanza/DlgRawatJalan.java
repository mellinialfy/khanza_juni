...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnPemeriksaanUrologi = new widget.Button();
        ...
        BtnPemeriksaanUrologi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnPemeriksaanUrologi.setText("Pemeriksaan Urologi");
        BtnPemeriksaanUrologi.setFocusPainted(false);
        BtnPemeriksaanUrologi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPemeriksaanUrologi.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnPemeriksaanUrologi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPemeriksaanUrologi.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnPemeriksaanUrologi.setName("BtnPemeriksaanUrologi"); // NOI18N
        BtnPemeriksaanUrologi.setPreferredSize(new java.awt.Dimension(180, 23));
        BtnPemeriksaanUrologi.setRoundRect(false);
        BtnPemeriksaanUrologi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPemeriksaanUrologiActionPerformed(evt);
            }
        });
        FormMenu.add(BtnPemeriksaanUrologi);
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnPemeriksaanUrologiActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        // TODO add your handling code here:
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
    ...
    */
    ...
    private widget.Button BtnPemeriksaanUrologi;
