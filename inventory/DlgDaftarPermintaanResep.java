...
public class DlgDaftarPermintaanResep extends javax.swing.JDialog {
    ...
    public DlgDaftarPermintaanResep(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                ...
                "Status","Kode Dokter","Poli/Unit","Kode Poli","Jenis Bayar","No. SEP","Tgl.Validasi","Jam Validasi",
    ...
    private void initComponents() {
        ...
        BtnRiwayatObat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        ...
        BtnRiwayatObat.setPreferredSize(new java.awt.Dimension(135, 23));
    ...
    public void tampil() {
        ...
        try{  
            ...
            ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,"+
                    ...
                    " reg_periksa.kd_poli,penjab.png_jawab,bridging_sep.no_sep,if(resep_obat.tgl_perawatan='0000-00-00','',resep_obat.tgl_perawatan) as tgl_perawatan,"+
                ...
                if(cmbStatus.getSelectedItem().toString().equals("Semua")){
                    while(rs.next()){
                        tabMode.addRow(new String[]{
                            ...
                            rs.getString("kd_dokter"),rs.getString("nm_poli"),rs.getString("kd_poli"),rs.getString("png_jawab"),rs.getString("no_sep"),
